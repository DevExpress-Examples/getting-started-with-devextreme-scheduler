# DevExtreme Angular Scheduler - Getting Started
...
To get more help on the Angular CLI, use `ng help` or review the [Angular CLI Overview and Command Reference](https://v17.angular.io/cli) page.
